...
<!--____________________________________________________________________________________________-->
	...
	<?php 
        ...
        $resultados1=$conexion->query("select * from productos where Descripcion = '$des' ");
                ...
                <div class="items class="row" style="margin-top:30px; margin-left:10px;">
                    <div>
                        <div class="tr_item shadow mb-3">
                            ...
                            echo '"><h3 class="tr_item-title">'.$fila["DescripcionB"];
    ...
    <?php 
        ...
        $resultados1=$conexion->query("select * from productos where DescripcionB = '$des' ");
        foreach ($resultados1 as $fila)
        {
            echo '<section class="store">
            <div class="container">
